...
<html lang="pl">
    ...
    <body>
        ...
        <div id="demo" class="carousel slide" data-interval="500000000" data-ride="carousel"> 
            ...
            <div id="carousel" class="carousel-inner h-100"> <!-- CAROUSEL START-->
                
                <div class="carousel-item  slide1 "> <!-- SLIDE 1 START -->
                    <div class="row">
                ...
                <div class="carousel-item slide2  active">
                    <!-- <div class="row">
                        <div class="col-md-12">       
                            <h1 class="display-1 text-white text-center">SPANKO</h1>
                        </div>
                    </div>
                    <div class="row"> -->
                        <div class="carousel-caption text-white">
                            <h1>Chce mi sie spac pomocy</h1>
                        </div>
                    <!-- </div> -->
                </div>
